...
class TicTacToe:
    def __init__(self):
        self.board = [' ' for i in range(9)] # generate a 3 * 3 board
    ...
    def winner(self , square , letter):
        # winner if 3 in a row . we have to check all the posibilities.
        row_ind = square // 3
...
if __name__ == '__main__':
    ...
    print(f'after 100 iteration, we see {x_win} X wins, {o_win} O wins and {ties} ties!')
